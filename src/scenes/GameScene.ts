...
export class GameScene extends BaseScene {
  ...
  private handleInput(): void {
    ...
    if (this.inputSystem.isKeyDown('KeyW') || this.inputSystem.isKeyDown('ArrowUp')) { // (gemini)
      this.movePlayer(Direction.Up); // (gemini)
    } else if (this.inputSystem.isKeyDown('KeyS') || this.inputSystem.isKeyDown('ArrowDown')) { // (gemini)
      this.movePlayer(Direction.Down); // (gemini)
    } else if (this.inputSystem.isKeyDown('KeyA') || this.inputSystem.isKeyDown('ArrowLeft')) { // (gemini)
      this.movePlayer(Direction.Left); // (gemini)
    } else if (this.inputSystem.isKeyDown('KeyD') || this.inputSystem.isKeyDown('ArrowRight')) { // (gemini)
